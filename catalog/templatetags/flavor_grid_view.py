...
def flavor_grid_view(request,flavor,volume_id,back_url):
	# name is volume name
	...
	return {'request':request,'flavor_id': flavor,'name':current_volume.name,'current_volume':current_volume,'back_url':back_url }